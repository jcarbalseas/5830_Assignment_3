...
def get_contract_values(contract, admin_address, owner_address):
	...
	has_role = contract.functions.hasRole(default_admin_role, admin_address).call(), admin_address).call()  # Check the contract to see if the address "admin_address" has the role "default_admin_role"
